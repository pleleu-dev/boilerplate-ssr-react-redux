...
/******/ 		return __webpack_require__.p + "" + ({"chunk/Pokemon":"chunk/Pokemon"}[chunkId]||chunkId) + "." + {"chunk/Pokemon":"670eb5e935757c4e472c"}[chunkId] + ".bundle.js"
/******/ 	}
/******/
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return axios__WEBPACK_IMPORTED_MODULE_0___default.a.get("/api/pokemon/pikachu/").catch(handleAjaxRequestError);
...
function loadPokemon(store) {
  ...
  console.log("storeloadPokemon", store.getState());
  return store.dispatch(Object(_actions__WEBPACK_IMPORTED_MODULE_5__["fetchPokemon"])(options));
}
...
/******/ });
//# sourceMappingURL=main.40f0dd045599a48de253.js.map